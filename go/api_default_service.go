...
func (s *DefaultApiService) PatchUsersUserId(ctx context.Context, userId int32, userPatch UserPatch) (ImplResponse, error) {
...
func (s *DefaultApiService) PostUser(ctx context.Context, userDraft UserDraft) (ImplResponse, error) {
